...
/**
 * Use This code instead, it's for those that need custom tab. Add it to the library code, not the sample
 *
...
public class PagerSlidingTabStripCustom extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = com.astuetz.pagerslidingtabstrip.R.drawable.psts_background_tab;

    private Locale locale;

    public PagerSlidingTabStripCustom(Context context) {
        this(context, null);
    }

    public PagerSlidingTabStripCustom(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagerSlidingTabStripCustom(Context context, AttributeSet attrs, int defStyle) {
